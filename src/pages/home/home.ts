import { PointImagePage } from './../point-image/point-image';
...
export class HomePage {
   ...
   viewProfiePic()
    ...
    goOnGiftListPage()
    {
        this.navCtrl.push(RedeemTypePage,{'mode':'home',"balence_point":this.total_balance_point,  "redeem_point":this.karigar_detail.redeem_balance});
    }
    ...
    goOnPointImgPage(){
        this.navCtrl.push(PointImagePage);
    }
    viewDetail()
    {
    ...
    share()
    {
        ...
        let image = "";
        let app_url =  "https://apps.apple.com/us/app/magnus-rewards-program/id6446076918";
